...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      local lua_snippets_path = vim.fn.stdpath 'config' .. '/lua_snippets'
  ...
  },
  {
    ...
    init = function()
      ...
      --vim.g.vimtex_view_general_options = "-x \"nvim --headless -c 'VimtexInverseSearch %{line} %{input}'\" @pdf --synctex-forward"
